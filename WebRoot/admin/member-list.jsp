    ...
    <div class="x-body">
      ...
      <table class="layui-table">
        ...
        <tbody>
          ...
          <c:if test="${backUser!=null}">
          	<c:forEach var="user" items="${backUser}" >
          		<tr>
         			<td><c:out value="${user.userId}"/></td>
         			<td><c:out value="${user.userName}"/></td>
         			<td><c:out value="${user.userTpye}"/></td>
         			<td><c:out value="${user.e_mail}"/></td>
         			<td><c:out value="${user.verification}"/></td>
         			<td><c:out value="${user.integralNumber}"/></td>
          		</tr>
          	</c:forEach>
          	<td class="td-status">
              <span class="layui-btn layui-btn-normal layui-btn-mini">已启用</span></td>
